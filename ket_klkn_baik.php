    ...
    <section class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Pengajuan Surat Keterangan Berkelakuan</h2>
        </div>

        <div class="row">

          <div class="col-lg-12">
            <form action="ajuan.php?kategori_surat=ket_klkn_baik" method="post" role="form" class="php-email-form"  enctype="multipart/form-data">
              <div class="row">

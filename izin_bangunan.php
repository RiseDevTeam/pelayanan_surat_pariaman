    ...
    <header id="header" class="fixed-top header-scrolled">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li class="dropdown"><a href="#" class="active"><span>Surat Izin</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                      <?php 
                        if(isset($_SESSION['nomor_ktp'])){
                          echo"
    ...
    <section class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Pengajuan Surat Izin Bangunan</h2>
        </div>

        <div class="row">

          <div class="col-lg-12">
            <form action="ajuan.php?kategori_surat=izin_bangunan" method="post" role="form" class="php-email-form" enctype="multipart/form-data">
              <div class="row">
                <?php
                  $sql = mysqli_query($conn,"SELECT * FROM surat_izin WHERE kategori_surat = 'Surat Izin Bangunan'");
                  if(mysqli_num_rows($sql)>0){
                    $data = mysqli_fetch_assoc($sql);
                    if($data['formulir_surat']!=""){ ?>
                      <div class="form-group bg-red">
                        <p><b>Isi Formulir Surat Terlebih Dahulu!</b></p>
                        <a href="download.php?kategori_surat=usaha" class="btn btn-primary">Download Formulir</a>
                      </div>
                <?php } else {}
                ...
                <div class="form-group">
                  <label for="bukti_kepemilikan_tanah">Fotocopy Bukti Pemilikan Hak Atas Tanah</label>
                  <input type="file" class="form-control" name="bukti_kepemilikan_tanah" id="formFile">
                </div>
                <div class="form-group">
                  <label for="denah_lokasi">Denah Lokasi yang Dibangun</label>
                  <input type="file" class="form-control" name="denah_lokasi" id="formFile">
                </div>
                <div class="form-group">
                  <label for="rencana_bangunan">Gambar Rencana Bangunan yang Ditandatangani oleh Pemohon dan Diketahui oleh Lurah / Kepala Desa</label>
                  <input type="file" class="form-control" name="rencana_bangunan" id="formFile">
                </div>
                <div class="form-group">
                  <label for="persetujuan_tetangga">Persetujuan Tetanga yang Diketahui oleh Lurah / Kepala Desa Bila Bangunan Berada Diatas Batas Tanah</label>
                  <input type="file" class="form-control" name="persetujuan_tetangga" id="formFile">
                </div>
                <div class="form-group">
                  <label for="pas_foto">Pas Foto 3x4 (1 Lembar)</label>
                  <input type="file" class="form-control" name="pas_foto" id="formFile">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="biaya">Biaya = Luas (L) x Terintegrasi (It) x Bagunan Gedung (Ik) x Harga Standar Bangunan Gedung (Hsbg)</label>
                  <input type="number" class="form-control" name="biaya" id="number">
                </div>
              </div>

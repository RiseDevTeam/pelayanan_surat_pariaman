    ...
    <section class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Pengajuan Surat Izin Usaha</h2>
        </div>

        <div class="row">

          <div class="col-lg-12">
            <form action="ajuan.php?kategori_surat=izin_usaha" method="post" role="form" class="php-email-form"  enctype="multipart/form-data">
              <div class="row">
              <?php
                ...
                <div class="form-group">
                  <label for="surat_pengantar">Surat Pengantar dari RW / RT Terkait Lokasi Diketahui oleh Lurah / Kepala Desa</label>
                ...
                <div class="form-group">
                  <label for="pas_foto">Pas Foto 4x6 (2 Lembar)</label>
                  <input type="file" class="form-control" name="pas_foto" id="formFile">
                </div>
                <div class="form-group">
                  <label for="formulir_surat">Formulir Surat yang Telah Diisi</label>
                  <input type="file" class="form-control" name="formulir_surat" id="formFile">
                </div>
              </div>

                        ...
                        <div class="card">
                            ...
                            <script type="text/javascript">
                                ...
                                function bulan(str) {
                                    ...
                                    xmlhttp.open("GET","../getsrt_rek.php?kategori=klkn_baik&tahun="+thn.value+"&bulan="+str,true);
                                    xmlhttp.send();
                                    } }
                                ...
                                function submit(){
                                        ...
                                        window.location.href = '../print_srt_rek.php?kategori=klkn_baik&bulan='+bln.value+'&tahun='+thn.value;
                                        }
                                    }
                            </script>

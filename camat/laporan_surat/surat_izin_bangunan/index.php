                        ...
                        <div class="card">
                            ...
                            <script type="text/javascript">
                                ...
                                function bulan(str) {
                                    ...
                                    xmlhttp.open("GET","../getsrt_izin.php?kategori=bangunan&tahun="+thn.value+"&bulan="+str,true);
                                    xmlhttp.send();
                                    } }
                                ...
                                function submit(){
                                        ...
                                        window.location.href = '../print_srt_izin.php?kategori=bangunan&bulan='+bln.value+'&tahun='+thn.value;
                                        }
                                    }
                            </script>

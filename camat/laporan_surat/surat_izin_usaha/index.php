...
if(isset($_SESSION['nomor_ktp'])){
    ...
    if($user['status']!="camat"){
        echo"<script>
        alert('Anda Bukan Camat!');
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Laporan Surat Izin</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                    <div class="p-3 w-100 mr-2" style="border: 1px solid silver">
                                    <select class="form-select p-1 w-40"
                                    id="tahun" onchange="tahun()">
                                        <option selected disabled>-Pilih Tahun-</option>
                                        <option value="2021">2021</option>
                                        <option value="2022">2022</option>
                                    </select>
                                    <select class="form-select p-1 w-40"
                                    id="bulan" onchange="bulan(this.value)">
                                        <option selected disabled>-Pilih Bulan-</option>
                                    </select>
                                    </div>
                                    <div class="">
                                        <button class="btn btn-success h-100" style="width:100px"
                                        onclick="submit()" name="submit">Print</button>
                                    </div>
                                </div>
                            ...
                            <script type="text/javascript">
                                ...
                                function bulan(str) {
                                    ...
                                    xmlhttp.open("GET","../getsrt_izin.php?kategori=usaha&tahun="+thn.value+"&bulan="+str,true);
                                    xmlhttp.send();
                                    } }
                                ...
                                function submit(){
                                        ...
                                        window.location.href = '../print_srt_izin.php?kategori=usaha&bulan='+bln.value+'&tahun='+thn.value;
                                        }
                                    }
                            </script>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="zero_config" class="table table-bordered no-wrap table-hover ">
                                        ...
                                        <!-- <?php
                                            ...
                                            $dedata = mysqli_query($conn,
                                            "SELECT * FROM laporan_surat_izin a INNER JOIN pengajuan_surat_izin b
                                            ON a.id_pengajuan_surat_izin = b.id_pengajuan_surat_izin
                                            WHERE a.kategori_surat = 'Surat Izin Usaha'");
                                            if(mysqli_num_rows($dedata)>0){
                                                while($data = mysqli_fetch_array($dedata)){
                                                    $ddedata = mysqli_query($conn,"SELECT * FROM user a INNER JOIN detail_user b
                                                    ON a.nomor_ktp = b.nomor_ktp
                                                    WHERE a.id_user = '$data[id_user]'");
                                                    $ddata = mysqli_fetch_array($ddedata);
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <embed src="../../../files/pengajuan_surat/surat_izin_usaha/<?php echo $folder ?>/<?php echo $data['file_surat_izin'] ?>"
                                                        style="width: 200px;">
                                                    </td>
                                                </tr>
                                        <?php

                        ...
                        <div class="card">
                            ...
                            <script type="text/javascript">
                                ...
                                function bulan(str) {
                                    ...
                                    xmlhttp.open("GET","../getsrt_rek.php?kategori=blm_menikah&tahun="+thn.value+"&bulan="+str,true);
                                    xmlhttp.send();
                                    } }
                                ...
                                function submit(){
                                        ...
                                        window.location.href = '../print_srt_rek.php?kategori=blm_menikah&bulan='+bln.value+'&tahun='+thn.value;
                                        }
                                    }
                            </script>

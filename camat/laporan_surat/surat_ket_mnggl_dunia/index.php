                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Laporan Surat Rekomendasi</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <script type="text/javascript">
                                ...
                                function bulan(str) {
                                    ...
                                    xmlhttp.open("GET","../getsrt_rek.php?kategori=mnggl_dunia&tahun="+thn.value+"&bulan="+str,true);
                                    xmlhttp.send();
                                    } }
                                ...
                                function submit(){
                                        ...
                                        window.location.href = '../print_srt_rek.php?kategori=mnggl_dunia&bulan='+bln.value+'&tahun='+thn.value;
                                        }
                                    }
                            </script>

            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item selected"> <a class="sidebar-link" href="../akun/index.php" aria-expanded="false"><i class='bx bxs-user-account bx-sm'></i><span class="hide-menu">Kelola Akun</span></a></li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Kelola Akun</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="tambah.php"><button class="btn btn-primary mb-2">Tambah Akun</button></a>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-bordered no-wrap table-hover ">
                                        ...
                                        <?php
                                            $data_akun = mysqli_query($conn,"SELECT * FROM detail_user, user WHERE detail_user.nomor_ktp = user.nomor_ktp");
                                            if(mysqli_num_rows($data_akun)>0){
                                                while($akun = mysqli_fetch_array($data_akun)){ ?>
                                                <tr>
                                                    <td><?php echo $akun['nama_lengkap']; ?></td>
                                                    <td><?php echo $akun['nomor_ktp']; ?></td>
                                                    <td><?php echo $akun['nip']; ?></td>
                                                    <td><?php echo $akun['nomor_telepon']; ?></td>
                                                    <td><?php echo $akun['alamat']; ?></td>
                                                    <td style="text-transform: capitalize;"><?php echo $akun['status']; ?></td>
                                                    <td><a href="edit.php?nomor_ktp=<?php echo $akun['nomor_ktp']; ?>"><button class="btn btn-outline-primary">Edit</button></a></td>
                                                </tr>
                                        <?php
                                                }
                                            }

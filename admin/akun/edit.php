            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item selected"> <a class="sidebar-link active" href="../akun/" aria-expanded="false"><i class='bx bxs-user-account bx-sm'></i><span class="hide-menu">Kelola Akun</span></a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Tambah Akun</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="beranda.php" class="text-muted">Beranda</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Kelola Akun</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php
                                    $data_akun = mysqli_query($conn,"SELECT * FROM detail_user, user 
                                    WHERE detail_user.nomor_ktp = '$_GET[nomor_ktp]' AND user.nomor_ktp = '$_GET[nomor_ktp]'");
                                    $akun =  mysqli_fetch_assoc($data_akun);
                                ?>

                                    <div class="form-body">
                                        <label><b>Nama Lengkap</b></label>
                                            <div class="form-group">
                                                <input type="text" class="form-control inputtan inputtan" name="nama_lengkap"
                                                value="<?php echo $akun["nama_lengkap"]; ?>">
                                            </div>
                                        <label><b>Nomor KTP</b></label>
                                            <div class="form-group">
                                                <input type="number" class="form-control inputtan" name="nomor_ktp"
                                                value="<?php echo $akun["nomor_ktp"]; ?>" readonly>
                                            </div>
                                        <label><b>Password</b></label>
                                            <div class="form-group">
                                                <input type="text" class="form-control inputtan" name="password"
                                                value="<?php echo $akun["password"]; ?>">
                                            </div>
                                        <label><b>NIP (*Kalau Ada)</b></label>
                                            <div class="form-group">
                                                <input type="number" class="form-control inputtan" name="nip"
                                                value="<?php echo $akun["nip"]; ?>">
                                            </div>
                                        <label><b>Nomor Telepon</b></label>
                                            <div class="form-group">
                                                <input type="number" class="form-control inputtan" name="nomor_telepon"
                                                value="<?php echo $akun["nomor_telepon"]; ?>">
                                            </div>
                                        <label><b>Alamat</b></label>
                                            <div class="form-group">
                                                <input type="text" class="form-control inputtan" name="alamat"
                                                value="<?php echo $akun["alamat"]; ?>">
                                            </div>
                                        <label><b>Status</b></label>
                                            <div class="form-group col-1">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    class="custom-control-input" value="camat"
                                                    <?php
                                                    if($akun['status']=="camat"){
                                                        echo"checked";
                                                    } else {}
                                                    ?>>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    ?>>
                                                    <label class="custom-control-label" for="status3">User</label>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="form-actions">
                                        <div class="text-right">
                                            ...
                                            <a href="hapus.php?nomor_ktp=<?php echo $_GET["nomor_ktp"]; ?>"
                                            class="btn btn-danger" onclick="return confirm('Anda yakin ingin menghapus akun ini?')">
                                            Hapus Akun</a>
                                        </div>
                                    </div>
            ...
            <?php
                if(isset($_POST['submit'])){
                    ...
                    $insert = mysqli_query($conn,"UPDATE user SET
                    password = '".$_POST['password']."',
                    status = '".$_POST['status']."'
                    WHERE nomor_ktp = '".$_GET['nomor_ktp']."'");

                    $insertt = mysqli_query($conn,"UPDATE detail_user SET

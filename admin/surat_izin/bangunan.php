...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Surat Izin</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <form action="tambah.php?kategori_surat=bangunan" method="post" enctype="multipart/form-data">
            ...
            ?>
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Formulir Surat Izin Bangunan</h4>
                                <h6 class="card-subtitle"><?php
                                    if($form == "kosong"){
                                        echo"(Jika diperlukan)";
                                    } else {
                                        echo"Upload yang Baru?";
                                    }
                                ?></h6>
                                ...
                                <?php
                                    if($form == "kosong"){
                                        ...
                                        <a href="hapus.php?kategori_surat=bangunan"
                                        class="btn btn-danger" onclick="return confirm('Anda yakin ingin menghapus formulir surat yg ada?')">
                                        Hapus Formulir yang Ada</a>
                                        <?php
                                     } ?>
                            </div>
                        </div>
                        ...
                        if($form == "kosong"){ } else { ?>
                            <div class="col-md-6 col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Formulir Surat Izin Bangunan</h4>
                                        <h6 class="card-subtitle">Klik Kanan dan Pilih Opsi 'Print' untuk Menyimpan File</h6>
                                        
                                        <embed src="../../files/formulir_surat/<?php echo $data['formulir_surat'] ?>">
                                    </div>
                                </div>
                            </div>
                                <?php    
                    ...
                    <div class="col-lg-12">
                        <div class="card" >
                            <div class="card-body">
                                <h4 class="card-title">Syarat - Syarat Surat Izin Bangunan</h4>
                                <div class="form-group">
                                    <textarea class="form-control" id="editor" name="syarat_surat">
                                        <?php if(isset($data['syarat_surat'])){

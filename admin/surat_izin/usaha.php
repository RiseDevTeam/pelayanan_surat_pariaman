...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <form action="tambah.php?kategori_surat=usaha" method="post" enctype="multipart/form-data">
            ...
            ?>
                ...
                <?php
                    ...
                    ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Formulir Surat Izin Usaha</h4>
                                ...
                                <a href="hapus.php?kategori_surat=usaha"
                    ...
                    <div class="col-lg-12">
                        <div class="card" >
                            <div class="card-body">
                                <h4 class="card-title">Syarat - Syarat Surat Izin Usaha</h4>

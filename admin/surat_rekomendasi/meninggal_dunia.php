...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <form action="tambah.php?kategori_surat=meninggal_dunia" method="post" enctype="multipart/form-data">

            <?php
                $sql = mysqli_query($conn,"SELECT * FROM surat_rekomendasi WHERE kategori_surat='Surat Keterangan Meninggal Dunia'");
            ...
            ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card" >
                            <div class="card-body">
                                <h4 class="card-title">Syarat - Syarat Surat Keterangan Meninggal Dunia</h4>

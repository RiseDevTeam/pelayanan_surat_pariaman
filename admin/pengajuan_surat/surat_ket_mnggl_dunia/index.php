                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-bordered no-wrap table-hover ">
                                        ...
                                        <?php
                                            ...
                                            "SELECT * FROM pengajuan_surat_rekomendasi,detail_user,user 
                                            WHERE pengajuan_surat_rekomendasi.kategori_surat = 'Surat Keterangan Meninggal Dunia' 
                                            AND pengajuan_surat_rekomendasi.id_user = user.id_user 
                                            AND user.nomor_ktp = detail_user.nomor_ktp");
                                            if(mysqli_num_rows($dedata)>0){
                                                while($data = mysqli_fetch_array($dedata)){
                                                    $lpr = mysqli_query($conn,"SELECT * FROM laporan_surat_rekomendasi
                                                    WHERE id_pengajuan_surat_rekomendasi = '$data[id_pengajuan_surat_rekomendasi]'"); ?>
                                                <tr>
                                                    ...
                                                    <?php
                                                    if(mysqli_num_rows($lpr)>0){ ?>
                                                    <button class="btn btn-primary w-100">Terkonfirmasi</button></td>
                                                    <?php } else { ?>
                                                    <a href="konfirmasi.php?id_user=<?php echo $data['id_user']; ?>&tgl=<?php echo $data['tgl'] ?>">
                                                    <button class="btn btn-outline-primary w-100">Konfirmasi Surat</button></a></td>
                                                    <?php } ?>
                                                </tr>
                                        <?php
                                                }

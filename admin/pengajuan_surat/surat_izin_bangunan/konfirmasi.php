            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="nav-small-cap selected"><span class="hide-menu">Pengajuan Surat</span></li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Surat Izin Bangunan</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="beranda.php" class="text-muted">Beranda</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Pengajuan Surat Izin</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Pengajuan Surat Izin Bangunan</h4>
                                
                                <?php

                                    $data_data = mysqli_query($conn,"SELECT * FROM pengajuan_surat_izin
                                    WHERE id_user = '$_GET[id_user]'
                                    AND kategori_surat = 'Surat Izin Bangunan'
                                    AND tgl = '$_GET[tgl]'");
                                ...
                                ?>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <label>Fotocopy KTP</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_bangunan/<?php echo $folder."/".$data['ktp']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=bangunan&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=ktp" 
                                        ...
                                        <label>Fotocopy Kartu Keluarga</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_bangunan/<?php echo $folder."/".$data['kartu_keluarga']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=bangunan&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=kartu_keluarga" 
                                                class="btn btn-primary">Download</a>
                                                <span><i><?php echo $data['kartu_keluarga'] ?></i></span>
                                                </div>
                                            </div>
                                        <label>Bukti Kepemilikan Hak Atas Tanah</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_bangunan/<?php echo $folder."/".$data['bukti_kepemilikan_tanah']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=bangunan&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=bukti_kepemilikan_tanah" 
                                                class="btn btn-primary">Download</a>
                                                <span><i><?php echo $data['bukti_kepemilikan_tanah'] ?></i></span>
                                                </div>
                                            </div>
                                        <label>Denah Lokasi yang Dibangun</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_bangunan/<?php echo $folder."/".$data['denah_lokasi']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=bangunan&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=denah_lokasi" 
                                                class="btn btn-primary">Download</a>
                                                <span><i><?php echo $data['denah_lokasi'] ?></i></span>
                                                </div>
                                            </div>
                                        <label>Gambar Rencana Bangunan</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_bangunan/<?php echo $folder."/".$data['rencana_bangunan']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=bangunan&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=rencana_bangunan" 
                                                class="btn btn-primary">Download</a>
                                                <span><i><?php echo $data['rencana_bangunan'] ?></i></span>
                                                </div>
                                            </div>
                                        <label>Persetujuan Tetangga</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_bangunan/<?php echo $folder."/".$data['persetujuan_tetangga']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=bangunan&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=persetujuan_tetangga" 
                                                class="btn btn-primary">Download</a>
                                                <span><i><?php echo $data['persetujuan_tetangga'] ?></i></span>
                                                </div>
                                            </div>
                                        <label>Pas Foto 3x4</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_bangunan/<?php echo $folder."/".$data['pas_foto']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=bangunan&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=pas_foto" 
                                                class="btn btn-primary">Download</a>
                                        ...
                                        <label>Bukti Tanda Lunas PBB Tahun Terakhir</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_bangunan/<?php echo $folder."/".$data['lunas_pbb']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=bangunan&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=lunas_pbb" 
                                                class="btn btn-primary">Download</a>
                                        ...
                                        <label>Biaya Bangunan</label>
                                            <div class="form-group">
                                                <span><b><?php echo $data['biaya'] ?></b></span>
                                            </div>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Konfirmasi Pengajuan Surat Izin Bangunan</h4>
                                <form action="../confirm_surat_izin.php?id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin']."&id_user=".$data['id_user'] ?>&kategori_surat=bangunan"
                                method="post" enctype="multipart/form-data">

                                <?php
                                $lprn = mysqli_query($conn,"SELECT * FROM laporan_surat_izin WHERE id_pengajuan_surat_izin = '$data[id_pengajuan_surat_izin]'");
                                $lapor = mysqli_fetch_assoc($lprn);
                                ?>

                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-bordered no-wrap table-hover ">
                                        ...
                                        <?php
                                            ...
                                            "SELECT pengajuan_surat_izin.tanggal, detail_user.nomor_telepon, detail_user.nomor_ktp, detail_user.nama_lengkap, pengajuan_surat_izin.status, pengajuan_surat_izin.id_user, pengajuan_surat_izin.tgl 
                                            FROM pengajuan_surat_izin,detail_user,user 
                                            WHERE pengajuan_surat_izin.kategori_surat = 'Surat Izin Bangunan' 
                                            AND pengajuan_surat_izin.id_user = user.id_user 
                                            AND user.nomor_ktp = detail_user.nomor_ktp");
                                            if(mysqli_num_rows($dedata)>0){
                                                ...
                                                <tr>
                                                    ...
                                                    if($data['status'] == "Pending"){
                                                        ...
                                                        href="https://web.whatsapp.com/send?phone=<?php echo '62' . $data['nomor_telepon']; ?>&text=Hai <?php echo $data['nama_lengkap'] ?>. Pengajuan Surat Izin Bangunan Anda Telah Dikonfirmasi dan Siap untuk Diurus Lebih Lanjut. Terima Kasih">
                                                    ...
                                                    <?php
                                                    if($data['status']=="Pending"){ ?>
                                                        <a href="konfirmasi.php?id_user=<?php echo $data['id_user']; ?>&tgl=<?php echo $data['tgl'] ?>">
                                                        <button class="btn btn-outline-primary">Konfirmasi Surat</button></a>
                                                    <?php } else { ?>
                                                        <span class="btn btn-primary w-100">Terkonfirmasi</span>
                                                    <?php }
                                                    ?>
                                                    </td>
                                                </tr>

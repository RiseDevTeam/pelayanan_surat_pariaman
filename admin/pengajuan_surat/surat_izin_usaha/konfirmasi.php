            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Surat Izin Usaha</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Pengajuan Surat Izin Usaha</h4>
                                
                                <?php

                                    $data_data = mysqli_query($conn,"SELECT * FROM pengajuan_surat_izin
                                    WHERE id_user = '$_GET[id_user]'
                                    AND kategori_surat = 'Surat Izin Usaha'
                                    AND tgl = '$_GET[tgl]'");
                                ...
                                ?>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <label>Fotocopy KTP</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_usaha/<?php echo $folder."/".$data['ktp']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=usaha&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=ktp" 
                                        ...
                                        <label>Fotocopy Kartu Keluarga</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_usaha/<?php echo $folder."/".$data['kartu_keluarga']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=usaha&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=kartu_keluarga" 
                                                class="btn btn-primary">Download</a>
                                                <span><i><?php echo $data['kartu_keluarga'] ?></i></span>
                                                </div>
                                            </div>
                                        <label>Surat Pengantar dari RT / RW Terkait Lokasi Diketahui oleh Lurah / Kepala Desa</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_usaha/<?php echo $folder."/".$data['surat_pengantar']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=usaha&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=surat_pengantar" 
                                                class="btn btn-primary">Download</a>
                                        ...
                                        <label>Pas Foto 3x4</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_usaha/<?php echo $folder."/".$data['pas_foto']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=usaha&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=pas_foto" 
                                                class="btn btn-primary">Download</a>
                                                <span><i><?php echo $data['pas_foto'] ?></i></span>
                                                </div>
                                            </div>
                                        <label>Formulir Surat</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_izin_usaha/<?php echo $folder."/".$data['formulir_surat']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_izin.php?kategori_surat=usaha&id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin'] ?>&file=formulir_surat" 
                                                class="btn btn-primary">Download</a>
                                                <span><i><?php echo $data['formulir_surat'] ?></i></span>
                                                </div>
                                            </div>
                                    </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Konfirmasi Pengajuan Surat Izin Usaha</h4>
                                <form action="../confirm_surat_izin.php?id_pengajuan_surat_izin=<?php echo $data['id_pengajuan_surat_izin']."&id_user=".$data['id_user'] ?>&kategori_surat=usaha"

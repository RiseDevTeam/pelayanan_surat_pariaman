            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Surat Keterangan Belum Menikah</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Pengajuan Surat Keterangan Belum Menikah</h4>
                                
                                <?php

                                    $data_data = mysqli_query($conn,"SELECT * FROM pengajuan_surat_rekomendasi
                                    WHERE id_user = '$_GET[id_user]'
                                    AND kategori_surat = 'Surat Keterangan Belum Menikah'
                                    AND tgl = '$_GET[tgl]'");
                                ...
                                ?>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <label>Fotocopy KTP</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_keterangan_belum_menikah/<?php echo $folder."/".$data['ktp']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_rekomendasi.php?kategori_surat=blm_menikah&id_pengajuan_surat_rekomendasi=<?php echo $data['id_pengajuan_surat_rekomendasi'] ?>&file=ktp" 
                                        ...
                                        <label>Fotocopy Kartu Keluarga</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_keterangan_belum_menikah/<?php echo $folder."/".$data['kartu_keluarga']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_rekomendasi.php?kategori_surat=blm_menikah&id_pengajuan_surat_rekomendasi=<?php echo $data['id_pengajuan_surat_rekomendasi'] ?>&file=kartu_keluarga" 
                                                class="btn btn-primary">Download</a>
                                        ...
                                        <label>Surat Pengantar Kelurahan / Desa</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_keterangan_belum_menikah/<?php echo $folder."/".$data['surat_pengantar']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_rekomendasi.php?kategori_surat=blm_menikah&id_pengajuan_surat_rekomendasi=<?php echo $data['id_pengajuan_surat_rekomendasi'] ?>&file=surat_pengantar" 
                                                class="btn btn-primary">Download</a>
                                        ...
                                        <label>Bukti Tanda Lunas PBB Tahun Terakhir</label>
                                            <div class="form-group">
                                                <div>
                                                <embed src="../../../files/pengajuan_surat/surat_keterangan_belum_menikah/<?php echo $folder."/".$data['lunas_pbb']; ?>"
                                                style="height: 150px; overflow: hidden">
                                                </div>
                                                <div>
                                                <a href="../download_surat_rekomendasi.php?kategori_surat=blm_menikah&id_pengajuan_surat_rekomendasi=<?php echo $data['id_pengajuan_surat_rekomendasi'] ?>&file=lunas_pbb" 
                                                class="btn btn-primary">Download</a>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Konfirmasi Pengajuan Surat Keterangan Belum Menikah</h4>
                                <form action="../confirm_surat_rekomendasi.php?id_pengajuan_surat_rekomendasi=<?php echo $data['id_pengajuan_surat_rekomendasi']."&id_user=".$data['id_user'] ?>&kategori_surat=blm_menikah"
